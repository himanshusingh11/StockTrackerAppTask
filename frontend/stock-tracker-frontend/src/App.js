...
//       setAllStocks(stocks);
//       const options = stocks && stocks.map((stock) => stock.symbol);
//       setStockOptions(options);

//       // Update price when a new stock is selected
//       const selectedStockData = stocks && stocks.find((stock) => stock.symbol === selectedStock);
//       if (selectedStockData) {
//         setPrice(selectedStockData.price);
//       }

//       setChartData({
//         labels: stocks && stocks.map((stock) => stock.symbol),
//         datasets: [
//           {
//             label: 'Stock Prices',
//             data: stocks && stocks.map((stock) => stock.price),
...
//   // Update the stock price every minute
//   useEffect(() => {
...
//                       // Also update the price when a new stock is selected
//                       const selectedStockData = allStocks.find(
